...
$(function () {
  ...
  metricsApp.Router = Backbone.Router.extend({
    ...
    setLagForRange: function() {
      ...
      if(wantedLag !== metricsApp.lag.selected) {
        metricsApp.lag.selected = wantedLag;
    ...
    initDateRangePicker: function() {
      ...
      this.dateRangePicker = WL.dateRangePicker.init(
        $('#metrics-dates'),
        this.startDate,
        this.endDate,
