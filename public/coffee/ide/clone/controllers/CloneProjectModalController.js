...
define([
	...
	App.controller('CloneProjectModalController', function($scope, $modalInstance, $timeout, $http, ide) {
		$scope.inputs = 
		...
		$scope.clone = function() {
			...
			return cloneProject($scope.inputs.projectName)
				.then(function(response) {
					const { data } = response;
					return window.location = `/project/${data.project_id}`;}).catch(function(response) {
