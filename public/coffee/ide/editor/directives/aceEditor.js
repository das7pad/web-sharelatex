...
], function(App, Ace, SearchBox, Vim, ModeList, UndoManager, AutoCompleteManager, SpellCheckManager, SpellCheckAdapter, HighlightsManager, CursorPositionManager, CursorPositionAdapter, TrackChangesManager, MetadataManager) {
	...
	App.directive("aceEditor", function($timeout, $compile, $rootScope, event_tracking, localStorage, $cacheFactory, metadata, graphics, preamble, files, $http, $q, $window) {
		...
		return  {
			...
			link(scope, element, attrs) {
				...
				const trackChangesManager   = new TrackChangesManager(scope, editor, element);
