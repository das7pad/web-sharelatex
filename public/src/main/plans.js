...
define([
	...
	return App.controller("PlansController", function($scope, $modal, event_tracking, MultiCurrencyPricing, $http, $filter, ipCookie) {
		...
		$scope.signUpNowClicked = function(plan, location){
			...
			return event_tracking.send('subscription-funnel', 'sign_up_now_button', plan);
		};
		...
		$scope.openGroupPlanModal = function() {
			...
			return event_tracking.send('subscription-funnel', 'plans-page', 'group-inquiry-potential');
		};
