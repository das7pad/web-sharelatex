...
module.exports = (ContactsController = {
	getContacts(req, res, next) {
		...
		return ContactManager.getContactIds(user_id, {limit: 50}, function(error, contact_ids) {
			if (error != null) { return next(error); }
			return UserGetter.getUsers(contact_ids, {
				...
				contacts.sort((a, b) => positions[a._id != null ? a._id.toString() : undefined] - positions[b._id != null ? b._id.toString() : undefined]);
				...
				return Modules.hooks.fire("getContacts", user_id, contacts, function(error, additional_contacts) {
					if (error != null) { return next(error); }
