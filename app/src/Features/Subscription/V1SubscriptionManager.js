...
module.exports = (V1SubscriptionManager = {
	...
	getPlanCodeFromV1(userId, callback) {
		if (callback == null) { callback = function(err, planCode, v1Id){}; }
		logger.log({userId}, "[V1SubscriptionManager] fetching v1 plan for user");
		return V1SubscriptionManager._v1Request(userId, {
			method: 'GET',
			url(v1Id) { return `/api/v1/sharelatex/users/${v1Id}/plan_code`; }
	...
	getSubscriptionsFromV1(userId, callback) {
		if (callback == null) { callback = function(err, subscriptions, v1Id) {}; }
		return V1SubscriptionManager._v1Request(userId, {
			method: 'GET',
			url(v1Id) { return `/api/v1/sharelatex/users/${v1Id}/subscriptions`; }
		}, callback);
	},
	...
	getSubscriptionStatusFromV1(userId, callback) {
		...
		return V1SubscriptionManager._v1Request(userId, {
			method: 'GET',
			url(v1Id) { return `/api/v1/sharelatex/users/${v1Id}/subscription_status`; }
		}, callback);
	},
	...
	cancelV1Subscription(userId, callback) {
		...
		return V1SubscriptionManager._v1Request(userId, {
			method: 'DELETE',
			url(v1Id) { return `/api/v1/sharelatex/users/${v1Id}/subscription`; }
		}, callback);
	},

	v1IdForUser(userId, callback) {
		if (callback == null) { callback = function(err, v1Id) {}; }
		return UserGetter.getUser(userId, {'overleaf.id': 1}, function(err, user) {
			if (err != null) { return callback(err); }
			const v1Id = __guard__(user != null ? user.overleaf : undefined, x => x.id);
			if ((v1Id == null)) {
	...
	_v1Request(userId, options, callback) {
		if (callback == null) { callback = function(err, body, v1Id){}; }
		...
		return V1SubscriptionManager.v1IdForUser(userId, function(err, v1Id) {
			if (err != null) { return callback(err); }
			if ((v1Id == null)) { return callback(null, null, null); }
			return request({
