(function() {
  var AuthenticationController, GithubSyncController, GithubSyncMiddlewear, SecurityManager;
  ...
  module.exports = {
    apply: function(app) {
      ...
      app.post('/project/:Project_id/github-sync/merge', SecurityManager.requestCanModifyProject, GithubSyncController.mergeProject);
      app.post('/project/:Project_id/github-sync/export', SecurityManager.requestIsOwner, GithubSyncController.exportProject);
      return app.post('/project/new/github-sync', AuthenticationController.requireLogin(), GithubSyncController.importProject);
    }
  };
