...
module.exports = (Features = {
	...
	hasFeature(feature) {
		switch (feature) {
			...
			case 'registration':
				return !Features.externalAuthenticationSystemUsed() || (Settings.overleaf != null);
			case 'github-sync':
				return Settings.enableGithubSync;
			case 'git-bridge':
				return Settings.enableGitBridge;
			case 'v1-return-message':
				return (Settings.accountMerge != null) && (Settings.overleaf != null) && !Settings.forceImportToV2;
			...
			case 'view-templates':
				return (Settings.overleaf == null);
			case 'affiliations':
				return (__guard__(__guard__(Settings != null ? Settings.apis : undefined, x1 => x1.v1), x => x.url) != null);
			case 'redirect-sl':
