...
module.exports =
	apply: (webRouter, apiRouter) ->
		...
		webRouter.post "/project/:project_id/doc/:doc_id/changes/accept", AuthorizationMiddlewear.ensureUserCanWriteProjectContent, TrackChangesController.bulkAcceptChanges
