...
const EmailBuilder = require('../../../../app/src/Features/Email/EmailBuilder')
...
`
  ...
  secondaryMessage() {
    return 'PS. We love talking to our users about ShareLaTeX. Reply to this email to get in touch with us directly, whatever the reason. Questions, comments, problems, suggestions, all welcome!'
  },
  ctaText() {
