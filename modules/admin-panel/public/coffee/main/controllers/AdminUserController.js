...
define([
	...
	App.controller("AdminUserController", function($scope, $timeout, $modal, queuedHttp) {
		...
		$scope.updateSelectedProjects = () => $scope.selectedProjects = $scope.projects.filter(project => project.selected);
		...
		$scope.openDeleteSecondaryEmailModal = function(emailToRemove) {
			const modalInstance = $modal.open({
				...
				resolve: {
					users() { return [{email:emailToRemove}]; }
				}
			});
	...
	App.controller('AdminDeleteProjectsModalController', function($scope, $modalInstance, $timeout, projects) {
	...
	App.controller('UnlinkOlModalController', function($scope, $modalInstance, $timeout, users) {
		$scope.users = users;
	...
	return App.controller('DeleteSecondaryEmailModalController', function($scope, $modalInstance, $timeout, users) {
		$scope.users = users;
