...
App.controller(
  'AdminUserController',
  function ($scope, $timeout, $modal, queuedHttp) {
...
App.controller(
  'AdminDeleteProjectsModalController',
  function ($scope, $modalInstance, $timeout, projects) {
...
App.controller(
  'UnlinkOlModalController',
  function ($scope, $modalInstance, $timeout, users) {
    $scope.users = users
...
export default App.controller(
  'DeleteSecondaryEmailModalController',
  function ($scope, $modalInstance, $timeout, users) {
    $scope.users = users
