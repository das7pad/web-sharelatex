...
App.controller(
  ...
  function ($scope, $http, $timeout, $window, $modal, queuedHttp) {
...
export default App.controller(
  'SetPasswordModalController',
  function ($scope, $modalInstance, $timeout, user) {
    $scope.user = user
    $scope.inputs = { newPassword: '' }
