      ...
      return (
        ...
        >
          <div className="col-sm-12">
            ...
            <p>
              This project has one or more files in subfolders, rather than at
              the top folder level. Although Overleaf allows you to create and
              nest folders within your project,
              {entry.name} requires all files to be at the top level of your
              project.
            </p>
            <p>
              Please move each of the above files to the top level of the
              project, check that your project renders properly, and then retry
              the submission. We apologize for the inconvenience.
            </p>
          </div>
        </div>
      )
