...
], (App, RichTextAdapter, SpellCheckManager, SpellCheckAdapter, AutocompleteAdapter, CursorPositionManager, CursorPositionAdapter, TrackChangesManager, TrackChangesAdapter) =>
    ...
    ({
      ...
      link(scope, element, attrs) {
        ...
        var initTrackChanges = function() {
          return this.trackChangesManager = new TrackChangesManager(scope, {}, element, new TrackChangesAdapter(editor));
        };
