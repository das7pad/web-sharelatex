...
const modulePath = require('path').join(__dirname, '../../../../app/js/Features/Tags/TagsController.js');
...
describe('TagsController', function() {
	...
	describe("getAllTags", () => it('should ask the handler for all tags', function(done){
        const allTags = [{name:"tag", projects:["123423","423423"]}];
        this.handler.getAllTags = sinon.stub().callsArgWith(1, null, allTags);
        return this.controller.getAllTags(this.req, { json:body=> {
