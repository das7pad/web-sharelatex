...
describe('UserSessionsManager', function() {
	...
	beforeEach(function() {
		...
		return this.UserSessionsManager = SandboxedModule.require(modulePath, { requires: {
	...
	describe('_sessionKey', () => it('should build the correct key', function() {
	...
	describe('trackSession', function() {
		...
		beforeEach(function() {
			this.call = callback => {
				return this.UserSessionsManager.trackSession(this.user, this.sessionId, callback);
			};
			this.rclient.exec.callsArgWith(0, null);
			return this._checkSessions = sinon.stub(this.UserSessionsManager, '_checkSessions').returns(null);
		});
		...
		describe('when no user is supplied', function() {
			...
			beforeEach(function() {
				return this.call = callback => {
					return this.UserSessionsManager.trackSession(null, this.sessionId, callback);
				};
			});
		...
		return describe('when no sessionId is supplied', function() {
			...
			beforeEach(function() {
				return this.call = callback => {
					return this.UserSessionsManager.trackSession(this.user, null, callback);
				};
			});
	...
	describe('untrackSession', function() {
		...
		beforeEach(function() {
			this.call = callback => {
				return this.UserSessionsManager.untrackSession(this.user, this.sessionId, callback);
			};
			this.rclient.exec.callsArgWith(0, null);
			return this._checkSessions = sinon.stub(this.UserSessionsManager, '_checkSessions').returns(null);
		});
		...
		describe('when no user is supplied', function() {
			...
			beforeEach(function() {
				return this.call = callback => {
					return this.UserSessionsManager.untrackSession(null, this.sessionId, callback);
				};
			});
		...
		return describe('when no sessionId is supplied', function() {
			...
			beforeEach(function() {
				return this.call = callback => {
					return this.UserSessionsManager.untrackSession(this.user, null, callback);
				};
			});
	...
	describe('revokeAllUserSessions', function() {
		...
		beforeEach(function() {
			...
			return this.call = callback => {
				return this.UserSessionsManager.revokeAllUserSessions(this.user, this.retain, callback);
			};
		});
		...
		it('should call the appropriate redis methods', function(done) {
			return this.call(err => {
				...
				expect(this.rclient.del.firstCall.args[0]).to.deep.equal(this.sessionKeys[0]);
				expect(this.rclient.del.secondCall.args[0]).to.deep.equal(this.sessionKeys[1]);

				this.rclient.srem.callCount.should.equal(1);
				expect(this.rclient.srem.firstCall.args[1]).to.deep.equal(this.sessionKeys);
		...
		describe('when a session is retained', function() {
			...
			return it('should remove all sessions except for the retained one', function(done) {
				return this.call(err => {
					...
					expect(this.rclient.srem.firstCall.args[1]).to.deep.equal(['sess:one', 'sess:three', 'sess:four']);
					return done();
				});
			});
		});
		...
		describe('when rclient produces an error', function() {
			...
			beforeEach(function() {
				return this.rclient.del = sinon.stub().callsArgWith(1, new Error('woops'));
			});
		...
		describe('when no user is supplied', function() {
			...
			beforeEach(function() {
				return this.call = callback => {
					return this.UserSessionsManager.revokeAllUserSessions(null, this.retain, callback);
				};
			});
	...
	describe('getAllUserSessions', function() {
		...
		beforeEach(function() {
			...
			return this.call = callback => {
				return this.UserSessionsManager.getAllUserSessions(this.user, this.exclude, callback);
			};
		});
