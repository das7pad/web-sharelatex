...
describe("ContactManager", function() {
	...
	describe("getContacts", function() {
		describe("with a successful response code", function() {
			beforeEach(function() {
				this.request.get = sinon.stub().callsArgWith(1, null, {statusCode: 204}, { contact_ids: (this.contact_ids = ["mock", "contact_ids"])});
				return this.ContactManager.getContactIds(this.user_id, { limit: 42 }, this.callback);
			});
			...
			return it("should call the callback with the contatcs", function() {
				return this.callback.calledWith(null, this.contact_ids).should.equal(true);
			});
		});

		return describe("with a failed response code", function() {
			beforeEach(function() {
				this.request.get = sinon.stub().callsArgWith(1, null, {statusCode: 500}, null);
				return this.ContactManager.getContactIds(this.user_id, { limit: 42 }, this.callback);
			});

			it("should call the callback with an error", function() {
				return this.callback.calledWith(new Error("contacts api responded with non-success code: 500")).should.equal(true);
			});
	...
	return describe("addContact", function() {
		describe("with a successful response code", function() {
			beforeEach(function() {
				...
				return this.ContactManager.addContact(this.user_id, this.contact_id, this.callback);
			});
