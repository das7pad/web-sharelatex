...
const modulePath = path.join(__dirname, "../../../../app/js/Features/Collaborators/CollaboratorsHandler");
const {
    expect
} = require("chai");
...
describe("CollaboratorsHandler", function() {
	beforeEach(function() {
		this.CollaboratorHandler = SandboxedModule.require(modulePath, { requires: {
	...
	describe("getMemberIdsWithPrivilegeLevels", function() {
		describe("with project", function() {
			beforeEach(function() {
				...
				this.ProjectGetter.getProject.withArgs(
					this.project_id,
				...
				return this.CollaboratorHandler.getMemberIdsWithPrivilegeLevels(this.project_id, this.callback);
			});
		...
		return describe("with a missing project", function() {
			...
			return it("should return a NotFoundError", function(done) {
				return this.CollaboratorHandler.getMemberIdsWithPrivilegeLevels(this.project_id, function(error) {
	...
	describe("getMemberIds", function() {
		beforeEach(function() {
			...
			return this.CollaboratorHandler.getMemberIds(this.project_id, this.callback);
		});
	...
	describe("getInvitedMemberIds", function() {
		beforeEach(function() {
			...
			this.CollaboratorHandler.getMemberIdsWithPrivilegeLevels
				.withArgs(this.project_id)
				.yields(null, [{id: "member-id-1", source: 'invite'}, {id: "member-id-2", source: 'token'}]);
			return this.CollaboratorHandler.getInvitedMemberIds(this.project_id, this.callback);
		});
	...
	describe("getMembersWithPrivilegeLevels", function() {
		beforeEach(function() {
			this.CollaboratorHandler.getMemberIdsWithPrivilegeLevels = sinon.stub();
			this.CollaboratorHandler.getMemberIdsWithPrivilegeLevels.withArgs(this.project_id).yields(null, [
			...
			this.UserGetter.getUserOrUserStubById.withArgs("read-only-ref-1").yields(null, { _id: "read-only-ref-1" });
			this.UserGetter.getUserOrUserStubById.withArgs("read-only-ref-2").yields(null, { _id: "read-only-ref-2" });
			this.UserGetter.getUserOrUserStubById.withArgs("read-write-ref-1").yields(null, { _id: "read-write-ref-1" });
			this.UserGetter.getUserOrUserStubById.withArgs("read-write-ref-2").yields(null, { _id: "read-write-ref-2" });
			this.UserGetter.getUserOrUserStubById.withArgs("doesnt-exist").yields(null, null);
			return this.CollaboratorHandler.getMembersWithPrivilegeLevels(this.project_id, this.callback);
		});
	...
	describe("getInvitedMembersWithPrivilegeLevels", function() {
		beforeEach(function() {
			...
			this.UserGetter.getUserOrUserStubById.withArgs("read-write-ref-2").yields(null, { _id: "read-write-ref-2" });
			this.UserGetter.getUserOrUserStubById.withArgs("doesnt-exist").yields(null, null);
			return this.CollaboratorHandler.getInvitedMembersWithPrivilegeLevels(this.project_id, this.callback);
		});
	...
	describe("getTokenMembersWithPrivilegeLevels", function() {
		beforeEach(function() {
			...
			this.UserGetter.getUserOrUserStubById.withArgs("read-write-ref-2").yields(null, { _id: "read-write-ref-2" });
			this.UserGetter.getUserOrUserStubById.withArgs("doesnt-exist").yields(null, null);
			return this.CollaboratorHandler.getTokenMembersWithPrivilegeLevels(this.project_id, this.callback);
		});
	...
	describe("getMemberIdPrivilegeLevel", function() {
		...
		it("should return the privilege level if it exists", function(done) {
			return this.CollaboratorHandler.getMemberIdPrivilegeLevel("member-id-2", this.project_id, function(error, level) {
		...
		return it("should return false if the member has no privilege level", function(done) {
			return this.CollaboratorHandler.getMemberIdPrivilegeLevel("member-id-3", this.project_id, function(error, level) {
		...
		describe("when user is a member of the project", function() {
			beforeEach(function() {
				this.CollaboratorHandler.getMemberIdsWithPrivilegeLevels.withArgs(this.project_id).yields(null, [
					...
					{ id: this.user_id, privilegeLevel: "readAndWrite", source: 'invite' }
				]);
				return this.CollaboratorHandler.isUserInvitedMemberOfProject(this.user_id, this.project_id, this.callback);
			});
	...
	describe("getProjectsUserIsMemberOf", function() {
		beforeEach(function() {
			...
			this.Project.find.withArgs({collaberator_refs:this.user_id}, this.fields).yields(null, ["mock-read-write-project-1", "mock-read-write-project-2"]);
			this.Project.find.withArgs({readOnly_refs:this.user_id}, this.fields).yields(null, ["mock-read-only-project-1", "mock-read-only-project-2"]);
			this.Project.find.withArgs({tokenAccessReadAndWrite_refs:this.user_id, publicAccesLevel: 'tokenBased'}, this.fields).yields(null, ["mock-token-read-write-project-1", "mock-token-read-write-project-2"]);
			this.Project.find.withArgs({tokenAccessReadOnly_refs:this.user_id, publicAccesLevel: 'tokenBased'}, this.fields).yields(null, ["mock-token-read-only-project-1", "mock-token-read-only-project-2"]);
			return this.CollaboratorHandler.getProjectsUserIsMemberOf(this.user_id, this.fields, this.callback);
		});
	...
	describe("removeUserFromProject", function() {
		beforeEach(function() {
			...
			return this.CollaboratorHandler.removeUserFromProject(this.project_id, this.user_id, this.callback);
		});
		...
		return it("should remove the user from mongo", function() {
			return this.Project.update
				.calledWith({
					...
					"$pull":{
						collaberator_refs:this.user_id, readOnly_refs:this.user_id,
						tokenAccessReadOnly_refs:this.user_id, tokenAccessReadAndWrite_refs:this.user_id
					}
				})
				.should.equal(true);
		});
	...
	describe("addUserToProject", function() {
		beforeEach(function() {
			this.Project.update = sinon.stub().callsArg(2);
			this.ProjectGetter.getProject = sinon.stub().callsArgWith(2, null, (this.project = {}));
			this.ProjectEntityHandler.flushProjectToThirdPartyDataStore = sinon.stub().callsArg(1);
			this.CollaboratorHandler.addEmailToProject = sinon.stub().callsArgWith(4, null, this.user_id);
			return this.ContactManager.addContact = sinon.stub();
		});

		describe("as readOnly", function() {
			beforeEach(function() {
				return this.CollaboratorHandler.addUserIdToProject(this.project_id, this.adding_user_id, this.user_id, "readOnly", this.callback);
			});
		...
		describe("as readAndWrite", function() {
			beforeEach(function() {
				return this.CollaboratorHandler.addUserIdToProject(this.project_id, this.adding_user_id, this.user_id, "readAndWrite", this.callback);
			});
		...
		describe("with invalid privilegeLevel", function() {
			beforeEach(function() {
				return this.CollaboratorHandler.addUserIdToProject(this.project_id, this.adding_user_id, this.user_id, "notValid", this.callback);
			});
		...
		return describe("with null adding_user_id", function() {
			beforeEach(function() {
				return this.CollaboratorHandler.addUserIdToProject(this.project_id, null, this.user_id, "readAndWrite", this.callback);
			});
	...
	describe("removeUserFromAllProjects", function() {
		beforeEach(function(done) {
			...
			this.CollaboratorHandler.getProjectsUserIsMemberOf.withArgs(this.user_id, { _id: 1 }).yields(
				null,
				{
			...
			return this.CollaboratorHandler.removeUserFromAllProjets(this.user_id, done);
		});
	...
	describe('getAllInvitedMembers', function() {
		...
		beforeEach(function() {
			this.owning_user = {_id: 'owner-id', email: 'owner@example.com', features: {a: 1}};
			this.readwrite_user = {_id: 'readwrite-id', email: 'readwrite@example.com'};
			this.members = [
				{user: this.owning_user,    privilegeLevel: "owner"},
				{user: this.readwrite_user, privilegeLevel: "readAndWrite"}
			];
			this.CollaboratorHandler.getInvitedMembersWithPrivilegeLevels = sinon.stub().callsArgWith(1, null, this.members);
			this.ProjectEditorHandler.buildOwnerAndMembersViews = sinon.stub().returns(this.views = {
				owner: this.owning_user,
				ownerFeatures: this.owning_user.features,
				members: [ {_id: this.readwrite_user._id, email: this.readwrite_user.email} ]
			});
			this.callback = sinon.stub();
			return this.CollaboratorHandler.getAllInvitedMembers(this.project_id, this.callback);
		});
		...
		it('should produce a list of members', function() {
			this.callback.callCount.should.equal(1);
			return expect(this.callback.firstCall.args[1]).to.deep.equal(this.views.members);
		});

		it('should call getMembersWithPrivileges', function() {
			this.CollaboratorHandler.getInvitedMembersWithPrivilegeLevels.callCount.should.equal(1);
			return this.CollaboratorHandler.getInvitedMembersWithPrivilegeLevels.firstCall.args[0].should.equal(this.project_id);
		});

		it('should call ProjectEditorHandler.buildOwnerAndMembersViews', function() {
			this.ProjectEditorHandler.buildOwnerAndMembersViews.callCount.should.equal(1);
			return this.ProjectEditorHandler.buildOwnerAndMembersViews.firstCall.args[0].should.equal(this.members);
		});

		return describe('when getMembersWithPrivileges produces an error', function() {

			beforeEach(function() {
				this.CollaboratorHandler.getInvitedMembersWithPrivilegeLevels = sinon.stub().callsArgWith(1, new Error('woops'));
				this.ProjectEditorHandler.buildOwnerAndMembersViews = sinon.stub().returns(this.views = {
					owner: this.owning_user,
					ownerFeatures: this.owning_user.features,
					members: [ {_id: this.readwrite_user._id, email: this.readwrite_user.email} ]
			...
			return it('should not call ProjectEditorHandler.buildOwnerAndMembersViews', function() {
				return this.ProjectEditorHandler.buildOwnerAndMembersViews.callCount.should.equal(0);
			});
		});
	});
	...
	describe('userIsTokenMember', function() {
		beforeEach(function() {
			...
			return this.Project.findOne = sinon.stub().callsArgWith(2, null, this.project);
		});

		it('should check the database', function(done) {
			return this.CollaboratorHandler.userIsTokenMember(this.user_id, this.project_id, (err, isTokenMember) => {
	...
	return describe('transferProjects', function() {
		beforeEach(function() {
			...
			return this.ProjectEntityHandler.flushProjectToThirdPartyDataStore = sinon.stub().yields();
		});

		describe("successfully", function() {
			beforeEach(function() {
				return this.CollaboratorHandler.transferProjects(this.from_user_id, this.to_user_id, this.callback);
			});
		...
		return describe("when flushing to TPDS fails", function() {
			beforeEach(function() {
				this.ProjectEntityHandler.flushProjectToThirdPartyDataStore = sinon.stub().yields(new Error('oops'));
				return this.CollaboratorHandler.transferProjects(this.from_user_id, this.to_user_id, this.callback);
			});
