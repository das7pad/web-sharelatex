...
const modulePath = "../../../../app/js/Features/Uploads/ProjectUploadController.js";
...
describe("ProjectUploadController", function() {
	beforeEach(function() {
		...
		return this.ProjectUploadController = SandboxedModule.require(modulePath, { requires: {
	...
	describe("uploadProject", function() {
		...
		describe("successfully", function() {
			beforeEach(function() {
				this.ProjectUploadManager.createProjectFromZipArchive =
					sinon.stub().callsArgWith(3, null, this.project);
		...
		describe("when ProjectUploadManager.createProjectFromZipArchive fails", function() {
			beforeEach(function() {
				this.ProjectUploadManager.createProjectFromZipArchive =
					sinon.stub().callsArgWith(3, new Error("Something went wrong"), this.project);
				return this.ProjectUploadController.uploadProject(this.req, this.res);
			});

			it("should return a failed response to the FileUploader client", function() {
				return expect(this.res.body).to.deep.equal(JSON.stringify({ success: false, error: "upload_failed" }));
			});
		...
		return describe("when ProjectUploadManager.createProjectFromZipArchive reports the file as invalid", function() {
			beforeEach(function() {
				this.ProjectUploadManager.createProjectFromZipArchive =
					sinon.stub().callsArgWith(3, new Errors.InvalidError("zip_contents_too_large"), this.project);
				return this.ProjectUploadController.uploadProject(this.req, this.res);
			});

			it("should return the reported error to the FileUploader client", function() {
				return expect(this.res.body).to.deep.equal(JSON.stringify({ success: false, error: "zip_contents_too_large" }));
			});
	...
	return describe("uploadFile", function() {
		...
		describe("successfully", function() {
			...
			beforeEach(function() {
				...
				this.FileSystemImportManager.addEntity = sinon.stub().callsArgWith(6, null, this.entity);
			...
			it("should insert the file", function() {
				return this.FileSystemImportManager.addEntity
					.calledWith(this.user_id, this.project_id, this.folder_id, this.name, this.path)
					.should.equal(true);
			});
		...
		describe("when FileSystemImportManager.addEntity returns an error", function() {
			beforeEach(function() {
				this.FileSystemImportManager.addEntity = sinon.stub()
