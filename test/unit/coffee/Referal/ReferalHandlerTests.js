...
const modulePath = require('path').join(__dirname, '../../../../app/js/Features/Referal/ReferalHandler.js');
...
describe('Referal handler', function() {
	...
	return describe('getting refered user_ids', function() {
		it('should get the user from mongo and return the refered users array', function(done){
			...
			return this.handler.getReferedUsers(this.user_id, function(err, passedReferedUserIds, passedReferedUserCount){
