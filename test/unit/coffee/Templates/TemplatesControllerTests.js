...
const modulePath = '../../../../app/js/Features/Templates/TemplatesController';

describe("TemplatesController", function() {

	beforeEach(function() {
		this.user_id = "user-id";
		this.TemplatesController = SandboxedModule.require(modulePath, { requires: {
	...
	return describe("createProjectFromV1Template", function() {
		...
		describe("on success", function() {
			beforeEach(function() {
				this.project =
					{_id: "project-id"};
				this.TemplatesManager.createProjectFromV1Template.yields(null, this.project);
				return this.TemplatesController.createProjectFromV1Template(this.req, this.res, this.next);
			});

			it("should call TemplatesManager", function() {
				return this.TemplatesManager.createProjectFromV1Template.should.have.been.calledWithMatch("brand-variation-id", "compiler", "main-file", "template-id", "template-name", "template-version-id", "user-id");
			});

			it("should redirect to project", function() {
				return this.res.redirect.should.have.been.calledWith("/project/project-id");
			});
