...
require('chai').should();
const modulePath = require('path').join(__dirname, '../../../../app/js/Features/Editor/EditorHttpController');

describe("EditorHttpController", function() {
	beforeEach(function() {
		this.EditorHttpController = SandboxedModule.require(modulePath, { requires: {
		...
		this.TokenAccessHandler.getRequestToken = sinon.stub().returns(this.token = null);
	...
	describe("joinProject", function() {
		beforeEach(function() {
			...
			this.EditorHttpController._buildJoinProjectView = sinon.stub().callsArgWith(3, null, this.projectView, "owner");
	...
	describe("_buildJoinProjectView", function() {
		beforeEach(function() {
			...
			this.invites = [
				{_id: "invite_one", email: "user-one@example.com", privileges: "readOnly", projectId: this.project._id},
				{_id: "invite_two", email: "user-two@example.com", privileges: "readOnly", projectId: this.project._id}
			];
			this.ProjectEditorHandler.buildProjectModelView = sinon.stub().returns(this.projectModelView);
			this.ProjectGetter.getProjectWithoutDocLines = sinon.stub().callsArgWith(1, null, this.project);
			this.CollaboratorsHandler.getInvitedMembersWithPrivilegeLevels = sinon.stub().callsArgWith(1, null, this.members);
			this.CollaboratorsHandler.getTokenMembersWithPrivilegeLevels = sinon.stub().callsArgWith(1, null, this.tokenMembers);
			this.CollaboratorsInviteHandler.getAllInvites = sinon.stub().callsArgWith(1, null, this.invites);
			return this.UserGetter.getUser = sinon.stub().callsArgWith(2, null, this.user);
		});
		...
		describe("when authorized", function() {
			beforeEach(function() {
				...
				return this.EditorHttpController._buildJoinProjectView(this.req, this.project_id, this.user_id, this.callback);
			});
			...
			return it("should return the project model view, privilege level and protocol version", function() {
				return this.callback.calledWith(null, this.projectModelView, "owner").should.equal(true);
			});
		});
	...
	describe("addDoc", function() {
		beforeEach(function() {
			...
			return this.EditorController.addDoc = sinon.stub().callsArgWith(6, null, this.doc);
		});
		...
		describe("successfully", function() {
			...
			it("should call EditorController.addDoc", function() {
				return this.EditorController.addDoc
					.calledWith(this.project_id, this.parent_folder_id, this.name, [], "editor", this.userId)
					.should.equal(true);
			});
	...
	describe("addFolder", function() {
		beforeEach(function() {
			...
			return this.EditorController.addFolder = sinon.stub().callsArgWith(4, null, this.folder);
		});
		...
		describe("successfully", function() {
			...
			it("should call EditorController.addFolder", function() {
				return this.EditorController.addFolder
					.calledWith(this.project_id, this.parent_folder_id, this.name, "editor")
					.should.equal(true);
			});

			return it("should send the folder back as JSON", function() {
				return this.res.json
					.calledWith(this.folder)
					.should.equal(true);
			});
		});
	...
	describe("renameEntity", function() {
		...
		it("should call EditorController.renameEntity", function() {
			return this.EditorController.renameEntity
				.calledWith(this.project_id, this.entity_id, this.entity_type, this.name, this.userId)
				.should.equal(true);
		});
	...
	describe("renameEntity with long name", function() {
		beforeEach(function() {
			...
			this.req.body =
				{name: (this.name = "EDMUBEEBKBXUUUZERMNSXFFWIBHGSDAWGMRIQWJBXGWSBVWSIKLFPRBYSJEKMFHTRZBHVKJSRGKTBHMJRXPHORFHAKRNPZGGYIOTEDMUBEEBKBXUUUZERMNSXFFWIBHGSDAWGMRIQWJBXGWSBVWSIKLFPRBYSJEKMFHTRZBHVKJSRGKTBHMJRXPHORFHAKRNPZGGYIOT")};
	...
	describe("moveEntity", function() {
		beforeEach(function() {
			...
			this.req.body =
				{folder_id: (this.folder_id = "folder-id-123")};
		...
		it("should call EditorController.moveEntity", function() {
			return this.EditorController.moveEntity
				.calledWith(this.project_id, this.entity_id, this.folder_id, this.entity_type, this.userId)
				.should.equal(true);
		});
	...
	return describe("deleteEntity", function() {
		...
		it("should call EditorController.deleteEntity", function() {
			return this.EditorController.deleteEntity
				.calledWith(this.project_id, this.entity_id, this.entity_type, "editor", this.userId)
				.should.equal(true);
		});
