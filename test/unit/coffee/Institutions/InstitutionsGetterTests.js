...
const modulePath = require('path').join(__dirname, '../../../../app/js/Features/Institutions/InstitutionsGetter.js');

describe('InstitutionsGetter', function() {
	beforeEach(function() {
		this.UserGetter = {getUserFullEmails: sinon.stub()};
		this.InstitutionsGetter = SandboxedModule.require(modulePath, { requires: {
	...
	return describe("getConfirmedInstitutions", function() {
			it('filters unconfirmed affiliations', function(done) {
				...
				return this.InstitutionsGetter.getConfirmedInstitutions(this.userId, function(error, institutions) {
