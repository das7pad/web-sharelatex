...
const modulePath = path.join(__dirname, "../../../../app/js/Features/Email/EmailBuilder");
const {
    expect
} = require("chai");
...
describe("EmailBuilder", function() {
	...
	beforeEach(function() {
		...
		return this.EmailBuilder = SandboxedModule.require(modulePath, { requires: {
	...
	describe("projectInvite", function() {
		...
		describe("when sending a normal email", function() {
			beforeEach(function() {
				return this.email = this.EmailBuilder.buildEmail("projectInvite", this.opts);
			});
