...
const modulePath = path.join(__dirname, "../../../../app/js/Features/Email/SpamSafe");
const SpamSafe = require(modulePath);
const {
    expect
} = require("chai");

describe("SpamSafe", () => it('should reject spammy names', function() {
    ...
    return expect(SpamSafe.safeEmail("sendME$$$@iAmAprince.com", "A collaborator")).to.equal("A collaborator");
}));
