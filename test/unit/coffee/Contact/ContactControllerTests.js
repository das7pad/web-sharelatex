...
describe("ContactController", function() {
	beforeEach(function() {
		...
		this.ContactController = SandboxedModule.require(modulePath, { requires: {
	...
	return describe("getContacts", function() {
		beforeEach(function() {
			...
			this.AuthenticationController.getLoggedInUserId = sinon.stub().returns(this.user_id);
			this.ContactManager.getContactIds = sinon.stub().callsArgWith(2, null, this.contact_ids);
			this.UserGetter.getUsers = sinon.stub().callsArgWith(2, null, this.contacts);
		...
		it("should populate the users contacts ids", function() {
			return this.UserGetter.getUsers
				.calledWith(this.contact_ids, { email: 1, first_name: 1, last_name: 1, holdingAccount: 1 })
				.should.equal(true);
		});
