...
const modulePath = path.join(__dirname, "../../../../app/js/Features/Chat/ChatController");
const {
    expect
} = require("chai");
...
describe("ChatController", function() {
	beforeEach(function() {
		...
		this.ChatController = SandboxedModule.require(modulePath, { requires: {
	...
	describe("sendMessage", function() {
		beforeEach(function() {
			...
			this.ChatApiHandler.sendGlobalMessage = sinon.stub().yields(null, (this.message = {"mock": "message", user_id: this.user_id}));
	...
	describe("getMessages", function() {
		beforeEach(function() {
			...
			this.ChatApiHandler.getGlobalMessages = sinon.stub().yields(null, (this.messages = ["mock", "messages"]));
