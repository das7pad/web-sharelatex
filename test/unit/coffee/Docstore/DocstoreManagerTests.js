...
describe("DocstoreManager", function() {
	beforeEach(function() {
		...
		this.DocstoreManager = SandboxedModule.require(modulePath, { requires: {
	...
	describe("deleteDoc", function() {
		describe("with a successful response code", function() {
			beforeEach(function() {
				...
				return this.DocstoreManager.deleteDoc(this.project_id, this.doc_id, this.callback);
			});

			it("should delete the doc in the docstore api", function() {
				return this.request.del
					.calledWith(`${this.settings.apis.docstore.url}/project/${this.project_id}/doc/${this.doc_id}`)
					.should.equal(true);
			});
		...
		describe("with a failed response code", function() {
			...
			it("should call the callback with an error", function() {
				return this.callback.calledWith(new Error("docstore api responded with non-success code: 500")).should.equal(true);
			});
		...
		return describe("with a missing (404) response code", function() {
			beforeEach(function() {
				this.request.del = sinon.stub().callsArgWith(1, null, {statusCode: 404}, "");
				return this.DocstoreManager.deleteDoc(this.project_id, this.doc_id, this.callback);
			});

			it("should call the callback with an error", function() {
				return this.callback.calledWith(new Errors.NotFoundError("tried to delete doc not in docstore")).should.equal(true);
			});
	...
	describe("updateDoc", function() {
		...
		describe("with a successful response code", function() {
			beforeEach(function() {
				this.request.post = sinon.stub().callsArgWith(1, null, {statusCode: 204}, { modified: this.modified, rev: this.rev });
				return this.DocstoreManager.updateDoc(this.project_id, this.doc_id, this.lines, this.version, this.ranges, this.callback);
			});
			...
			return it("should call the callback with the modified status and revision", function() {
				return this.callback.calledWith(null, this.modified, this.rev).should.equal(true);
			});
		});
	...
	describe("getDoc", function() {
		...
		describe("with a successful response code", function() {
			beforeEach(function() {
				this.request.get = sinon.stub().callsArgWith(1, null, {statusCode: 204}, this.doc);
				return this.DocstoreManager.getDoc(this.project_id, this.doc_id, this.callback);
			});
			...
			return it("should call the callback with the lines, version and rev", function() {
				return this.callback.calledWith(null, this.lines, this.rev, this.version, this.ranges).should.equal(true);
			});
		});
		...
		describe("with include_deleted=true", function() {
			beforeEach(function() {
				this.request.get = sinon.stub().callsArgWith(1, null, {statusCode: 204}, this.doc);
				return this.DocstoreManager.getDoc(this.project_id, this.doc_id, {include_deleted: true}, this.callback);
			});
		...
		return describe("with a missing (404) response code", function() {
			beforeEach(function() {
				this.request.get = sinon.stub().callsArgWith(1, null, {statusCode: 404}, "");
				return this.DocstoreManager.getDoc(this.project_id, this.doc_id, this.callback);
			});

			it("should call the callback with an error", function() {
				return this.callback.calledWith(new Errors.NotFoundError("doc not found in docstore")).should.equal(true);
			});
	...
	describe("getAllDocs", function() {
		describe("with a successful response code", function() {
			beforeEach(function() {
				this.request.get = sinon.stub().callsArgWith(1, null, {statusCode: 204}, (this.docs = [{ _id: "mock-doc-id" }]));
	...
	describe("getAllRanges", function() {
		describe("with a successful response code", function() {
			beforeEach(function() {
				this.request.get = sinon.stub().callsArgWith(1, null, {statusCode: 204}, (this.docs = [{ _id: "mock-doc-id", ranges: "mock-ranges" }]));
	...
	describe("archiveProject", function() {
		describe("with a successful response code", function() {
			beforeEach(function() {
				...
				return this.DocstoreManager.archiveProject(this.project_id, this.callback);
			});
	...
	return describe("unarchiveProject", function() {
		describe("with a successful response code", function() {
			beforeEach(function() {
				this.request.post = sinon.stub().callsArgWith(1, null, {statusCode: 204});
				return this.DocstoreManager.unarchiveProject(this.project_id, this.callback);
			});
