...
const modulePath = Path.join(__dirname, "../../../../app/js/Features/Project/ProjectCollabratecDetailsHandler");
...
describe("ProjectCollabratecDetailsHandler", function() {
	beforeEach(function() {
		...
		this.ProjectModel = {};
		this.ProjectCollabratecDetailsHandler = SandboxedModule.require(modulePath, { requires: {
	...
	describe("initializeCollabratecProject", function() {
		...
		describe("when update succeeds", function() {
			beforeEach(function() {
				...
				return this.ProjectCollabratecDetailsHandler.initializeCollabratecProject(this.projectId, this.userId, "collabratec-document-id", "collabratec-private-group-id", this.callback);
			});
			...
			return it("should update project model", function() {
				...
				return expect(this.ProjectModel.update).to.have.been.calledWith({ _id: this.projectId }, update, this.callback);
			});
		});
		...
		return describe("with invalid args", function() {
			beforeEach(function() {
				...
				return this.ProjectCollabratecDetailsHandler.initializeCollabratecProject("bad-project-id", "bad-user-id", "collabratec-document-id", "collabratec-private-group-id", this.callback);
			});
	...
	describe("isLinkedCollabratecUserProject", function() {
		...
		describe("when find succeeds", function() {
			describe("when user project found", function() {
				beforeEach(function() {
					...
					return this.ProjectCollabratecDetailsHandler.isLinkedCollabratecUserProject(this.projectId, this.userId, this.callback);
				});
		...
		return describe("with invalid args", function() {
			beforeEach(function() {
				...
				return this.ProjectCollabratecDetailsHandler.isLinkedCollabratecUserProject("bad-project-id", "bad-user-id", this.callback);
			});
	...
	describe("linkCollabratecUserProject", function() {
		...
		describe("when update succeeds", function() {
			beforeEach(function() {
				this.ProjectModel.update = sinon.stub().yields();
				return this.ProjectCollabratecDetailsHandler.linkCollabratecUserProject(this.projectId, this.userId, "collabratec-document-id", this.callback);
			});
			...
			return it("should update project model", function() {
				...
				const update = { $push: { collabratecUsers: {
					collabratec_document_id: "collabratec-document-id",
					user_id: this.userId
				}
			}
			};
				return expect(this.ProjectModel.update).to.have.been.calledWith(query, update, this.callback);
			});
		});
		...
		return describe("with invalid args", function() {
			beforeEach(function() {
				this.ProjectModel.update = sinon.stub();
				return this.ProjectCollabratecDetailsHandler.linkCollabratecUserProject("bad-project-id", "bad-user-id", "collabratec-document-id", this.callback);
			});
	...
	describe("setCollabratecUsers", function() {
		...
		describe("when update succeeds", function() {
			beforeEach(function() {
				this.ProjectModel.update = sinon.stub().yields();
				return this.ProjectCollabratecDetailsHandler.setCollabratecUsers(this.projectId, this.collabratecUsers, this.callback);
			});
		...
		describe("with invalid project_id", function() {
			beforeEach(function() {
				this.ProjectModel.update = sinon.stub();
				return this.ProjectCollabratecDetailsHandler.setCollabratecUsers("bad-project-id", this.collabratecUsers, this.callback);
			});
	...
	describe("unlinkCollabratecUserProject", function() {
		...
		describe("when update succeeds", function() {
			beforeEach(function() {
				this.ProjectModel.update = sinon.stub().yields();
				return this.ProjectCollabratecDetailsHandler.unlinkCollabratecUserProject(this.projectId, this.userId, this.callback);
			});

			return it("should update project model", function() {
				const query =
					{_id: this.projectId};
				const update = { $pull: { collabratecUsers: {
					user_id: this.userId
				}
			}
			};
		...
		return describe("with invalid args", function() {
			beforeEach(function() {
				this.ProjectModel.update = sinon.stub();
				return this.ProjectCollabratecDetailsHandler.unlinkCollabratecUserProject("bad-project-id", "bad-user-id", this.callback);
			});
	...
	return describe("updateCollabratecUserIds", function() {
		...
		describe("when update succeeds", function() {
			beforeEach(function() {
				this.ProjectModel.update = sinon.stub().yields();
				return this.ProjectCollabratecDetailsHandler.updateCollabratecUserIds(this.userId, this.userId2, this.callback);
			});

			return it("should update project model", function() {
				return expect(this.ProjectModel.update).to.have.been.calledWith({ "collabratecUsers.user_id": this.userId }, { $set: {"collabratecUsers.$.user_id": this.userId2} }, { multi: true},  this.callback);
			});
		});
		...
		describe("with invalid old_user_id", function() {
			beforeEach(function() {
				this.ProjectModel.update = sinon.stub();
				return this.ProjectCollabratecDetailsHandler.updateCollabratecUserIds("bad-user-id", this.userId2, this.callback);
			});
		...
		return describe("with invalid new_user_id", function() {
			beforeEach(function() {
				this.ProjectModel.update = sinon.stub();
				return this.ProjectCollabratecDetailsHandler.updateCollabratecUserIds(this.userId, "bad-user-id", this.callback);
			});
