...
const modulePath = path.join(__dirname, '../../../../app/js/Features/DocumentUpdater/DocumentUpdaterHandler');
...
describe('DocumentUpdaterHandler', function() {
	beforeEach(function() {
		...
		return this.handler = SandboxedModule.require(modulePath, { requires: {
			'request': { defaults:() => { return this.request; }
		},
	...
	describe('flushProjectToMongo', function() {
		describe("successfully", function() {
			...
			it('should flush the document from the document updater', function() {
				return this.request.calledWithMatch({
		...
		describe("when the document updater API returns an error", function() {
			beforeEach(function() {
				this.request.callsArgWith(1, (this.error = new Error("something went wrong")), null, null);
				return this.handler.flushProjectToMongo(this.project_id, this.callback);
			});
	...
	describe('flushProjectToMongoAndDelete', function() {
		describe("successfully", function() {
			beforeEach(function() {
				this.request.callsArgWith(1, null, {statusCode: 204}, "");
				return this.handler.flushProjectToMongoAndDelete(this.project_id, this.callback);
			});
	...
	describe('flushDocToMongo', function() {
		describe("successfully", function() {
			beforeEach(function() {
				this.request.callsArgWith(1, null, {statusCode: 204}, "");
				return this.handler.flushDocToMongo(this.project_id, this.doc_id, this.callback);
			});
	...
	describe("deleteDoc", function() {
		describe("successfully", function() {
			beforeEach(function() {
				this.request.callsArgWith(1, null, {statusCode: 204}, "");
				return this.handler.deleteDoc(this.project_id, this.doc_id, this.callback);
			});
	...
	describe("setDocument", function() {
		...
		describe("successfully", function() {
			beforeEach(function() {
				this.request.callsArgWith(1, null, {statusCode: 204}, "");
				return this.handler.setDocument(this.project_id, this.doc_id, this.user_id, this.lines, this.source, this.callback);
			});
	...
	describe("getDocument", function() {
		describe("successfully", function() {
			beforeEach(function() {
				...
				return this.handler.getDocument(this.project_id, this.doc_id, this.fromVersion, this.callback);
			});
	...
	describe("getProjectDocsIfMatch", function() {
		...
		describe("successfully", function() {
			beforeEach(function() {
				...
				this.request.post = sinon.stub().callsArgWith(1, null, {statusCode: 200}, this.body);
				return this.handler.getProjectDocsIfMatch(this.project_id, this.project_state_hash, this.callback);
			});
			...
			return it("should call the callback with the documents", function() {
				return this.callback.calledWithExactly(null, this.docs).should.equal(true);
			});
		});
		...
		return describe("when the document updater returns a conflict error code", function() {
			beforeEach(function() {
				this.request.post = sinon.stub().callsArgWith(1, null, { statusCode: 409 }, "Conflict");
				return this.handler.getProjectDocsIfMatch(this.project_id, this.project_state_hash, this.callback);
			});
	...
	describe("acceptChanges", function() {
		...
		describe("successfully", function() {
			beforeEach(function() {
				this.request.callsArgWith(1, null, {statusCode: 200}, this.body);
				return this.handler.acceptChanges(this.project_id, this.doc_id, [ this.change_id ], this.callback);
			});
	...
	describe("deleteThread", function() {
		...
		describe("successfully", function() {
			beforeEach(function() {
				this.request.callsArgWith(1, null, {statusCode: 200}, this.body);
				return this.handler.deleteThread(this.project_id, this.doc_id, this.thread_id, this.callback);
			});
	...
	return describe("updateProjectStructure ", function() {
		...
		describe("with project history disabled", function() {
			beforeEach(function() {
				...
				return this.handler.updateProjectStructure(this.project_id, this.projectHistoryId, this.user_id, {}, this.callback);
			});
		...
		return describe("with project history enabled", function() {
			...
			describe("when an entity has changed name", () => it('should send the structure update to the document updater', function(done) {
                ...
                this.changes = {
                    ...
                    newDocs: [
                        { path: '/old_a', doc: {_id: new ObjectId(this.docIdA.toString())} },
                        { path: '/new_b', doc: {_id: new ObjectId(this.docIdB.toString())} }
                    ],
                ...
                return this.handler.updateProjectStructure(this.project_id, this.projectHistoryId, this.user_id, this.changes, () => {
                    this.request.calledWith({
                        url: this.url,
                        method: "POST",
                        json: {docUpdates, fileUpdates: [], userId: this.user_id, version: this.version, projectHistoryId: this.projectHistoryId}
                    })
                    .should.equal(true);
                    return done();
                });
			...
			describe("when a doc has been added", () => it('should send the structure update to the document updater', function(done) {
			...
			describe("when a file has been added", () => it('should send the structure update to the document updater', function(done) {
                this.fileId = new ObjectId();
                this.changes = {
                    newFiles: [
                        { path: '/bar', url: 'filestore.example.com/file', file: {_id: this.fileId, hash: "12345" }}
                    ],
                    newProject: {version: this.version}
                };
			...
			describe("when an entity has been deleted", () => it('should end the structure update to the document updater', function(done) {
                this.docId = new ObjectId();
                this.changes = {
                    oldDocs: [
                        { path: '/foo', docLines: 'a\nb', doc: {_id: this.docId} }
			...
			return describe("when the project version is missing", () => it('should call the callback with an error', function() {
                this.docId = new ObjectId();
                this.changes = {
                    oldDocs: [
                        { path: '/foo', docLines: 'a\nb', doc: {_id: this.docId} }
                ...
                this.handler.updateProjectStructure(this.project_id, this.projectHistoryId, this.user_id, this.changes, this.callback);
                
                this.callback.calledWith(new Error()).should.equal(true);
                const firstCallArgs = this.callback.args[0];
                return firstCallArgs[0].message.should.equal("did not receive project version in changes");
            }));
		});
	});
});