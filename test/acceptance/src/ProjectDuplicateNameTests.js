		...
		before(function(done) {
			return this.owner.createProject("example-project", {template: "example"}, (error, project_id) => {
				...
				return this.owner.getProject(project_id, (error, project) => {
					...
					this.mainTexDoc = _.find(project.rootFolder[0].docs, doc => doc.name === 'main.tex');
					this.refBibDoc = _.find(project.rootFolder[0].docs, doc => doc.name === 'references.bib');
					this.imageFile = _.find(project.rootFolder[0].fileRefs, file => file.name === 'universe.jpg');
