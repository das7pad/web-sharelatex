...
module.exports = (MockProjectHistoryApi = {
	...
	addLabel(project_id, label) {
		...
		if (this.labels[project_id] == null) { this.labels[project_id] = {}; }
	...
	getLabels(project_id) {
		if (this.labels[project_id] == null) { return null; }
	...
	run() {
		...
		app.delete("/project/:project_id/user/:user_id/labels/:label_id", (req, res, next) => {
			...
			const label = this.labels[project_id] != null ? this.labels[project_id][label_id] : undefined;
			if (label != null) {
